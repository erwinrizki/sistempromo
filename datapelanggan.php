	...
	<div class="col-lg-12">
		...
		<?php 
			...
			if(isset($_SESSION['update'])) {
				...
				<button type='button' class='close' data-dismiss='alert'>×</button>
				<span class='glyphicon glyphicon-ok' aria-hidden='true'></span>
				Update Data Pelanggan Berhasil</div>";
		...
		?>
		<br/>
		<a href="tambahpelanggan.php" role="button" class="btn btn-success">
		...
		<table class="table table-bordered">
		  ...
		  <tbody>
			...
			<tr>
				...
				<td><?php echo $hp ?></td>
				<td>
					<div style='margin-right:-100px; margin-left:+30'>
					<a href="detailpelanggan.php?id=<?php echo $id; ?>" role="button" class="btn btn-info">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<a href="processpelanggan.php?act=del&id=<?php echo $id; ?>" type="button" class="btn btn-primary">Ya</a>
								</div>
							</div>
						</div>
					</div>
